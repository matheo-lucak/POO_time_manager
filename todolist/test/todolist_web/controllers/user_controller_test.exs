...
#   describe "index" do
#     test "lists all users. One user", %{conn: conn} do
#       {user: user, token: token} = user_login_fixture(conn)
...
#             username: "unmatched username",
#             email: "unmatched@email.fr"
#           )
#         )
...
#         get(
#           conn,
#           Routes.user_path(conn, :index, username: "unique username", email: "unmatched@email.fr")
#         )
...
#         get(
#           conn,
#           Routes.user_path(conn, :index, username: "unmatched username", email: "unique@email.fr")
#         )
...
#         get(
#           conn,
#           Routes.user_path(conn, :index, username: "unique username", email: "unique@email.fr")
#         )
...
#         get(
#           conn,
#           Routes.user_path(conn, :index, username: "clone username", email: "clone@email.fr")
#         )
